...
public class Menu extends BaseEntity<Menu>{
	...
	public String toString() {
		return "Menu [menu_id=" + menu_id + ", menu_name=" + menu_name + ", remark=" + remark + ", menu_url=" + menu_url
				+ ", menu_class=" + menu_class + ", menu_type=" + menu_type + ", level=" + level + ", parent_id="
				+ parent_id + ", sort=" + sort + ", status=" + status + ", subMenus=" + subMenus + "]";
	}
